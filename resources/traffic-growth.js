...
(function(root){
	...
	function TrafficGrowth(){
		...
		this.display = function(){
			...
			html = '<div id="calendar-view"></div><h2>Counts by hour of day ('+ds.toISOString().substr(0,10)+' &rarr; '+de.toISOString().substr(0,10)+')</h2><div id="barchart-hourly"></div><h2>Counts by day of week ('+ds.toISOString().substr(0,10)+' &rarr; '+de.toISOString().substr(0,10)+')</h2><div id="barchart-dow"></div><h2>Counts by month ('+ds.toISOString().substr(0,10)+' &rarr; '+de.toISOString().substr(0,10)+')</h2><div id="barchart-monthly"></div><h2>Counts by year ('+ds.toISOString().substr(0,10)+' &rarr; '+de.toISOString().substr(0,10)+')</h2><p>Note that bars in this bar chart may not have data for the complete year so may appear lower than they might if the year was complete. For instance, the year a counter(s) started will be a partial year (unless it started on January 1st) as will the latest year. Other years may also have periods when the counter(s) did not collect data. You can check for missing days in the <a href="#calendar-view">calendar plots</a> above.</p><div id="barchart-yearly"></div>';
